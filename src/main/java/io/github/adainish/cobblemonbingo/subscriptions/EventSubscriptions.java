package io.github.adainish.cobblemonbingo.subscriptions;
...
public class EventSubscriptions
{
    ...
    public void loadPlayerSubscriptions()
    {
        PlatformEvents.SERVER_PLAYER_LOGIN.subscribe(Priority.NORMAL, serverPlayer -> {
            ...
            Player player = CobblemonBingo.playerStorage.getPlayer(serverPlayer.getPlayer().getUUID());
            if (player == null) {
                CobblemonBingo.playerStorage.makePlayer(serverPlayer.getPlayer());
                player = CobblemonBingo.playerStorage.getPlayer(serverPlayer.getPlayer().getUUID());
    ...
    public void init()
    {
        ...
        CobblemonEvents.POKEMON_CAPTURED.subscribe(Priority.NORMAL, event -> {
            Player player = CobblemonBingo.playerStorage.getPlayer(event.getPlayer().getUUID());
            if (player != null)
            {
