package io.github.adainish.cobblemonbingo;

import ca.landonjw.gooeylibs2.api.tasks.Task;
import com.cobblemon.mod.common.api.Priority;
import com.cobblemon.mod.common.platform.events.PlatformEvents;
import io.github.adainish.cobblemonbingo.cmd.Command;
import io.github.adainish.cobblemonbingo.conf.Config;
import io.github.adainish.cobblemonbingo.conf.DBConfig;
import io.github.adainish.cobblemonbingo.conf.LanguageConfig;
import io.github.adainish.cobblemonbingo.conf.RewardsConfig;
import io.github.adainish.cobblemonbingo.storage.Database;
import io.github.adainish.cobblemonbingo.storage.PlayerStorage;
import io.github.adainish.cobblemonbingo.subscriptions.EventSubscriptions;
import io.github.adainish.cobblemonbingo.tasks.SavePlayerTask;
import io.github.adainish.cobblemonbingo.wrapper.DataWrapper;
import kotlin.Unit;
...
public class CobblemonBingo implements ModInitializer {
    public static CobblemonBingo instance;
    ...
    public static void setConfigDir(File configDir) {
        CobblemonBingo.configDir = configDir;
    }
    ...
    public static void setPlayerStorageDir(File playerStorageDir) {
        CobblemonBingo.playerStorageDir = playerStorageDir;
    }
